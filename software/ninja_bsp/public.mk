...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../project_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is project_soc
SOPC_NAME := project_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1779634744
SOPC_SYSID_FLAG += --timestamp=1779634744
ELF_PATCH_FLAG  += --timestamp 1779634744
