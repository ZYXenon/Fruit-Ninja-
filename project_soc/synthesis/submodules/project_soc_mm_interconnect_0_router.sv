...
(
    ...
    localparam PAD14 = log2ceil(64'h160 - 64'h158); 
    localparam PAD15 = log2ceil(64'h168 - 64'h160); 
    ...
    // ( 0x100 .. 0x110 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 29'h100  && read_transaction  ) begin
    ...
    // ( 0x120 .. 0x130 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 29'h120  && read_transaction  ) begin
            src_channel = 18'b000000001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x130 .. 0x140 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 29'h130   ) begin
            src_channel = 18'b000000000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x140 .. 0x150 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 29'h140   ) begin
            src_channel = 18'b000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x158 .. 0x160 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 29'h158  && read_transaction  ) begin
            src_channel = 18'b000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x160 .. 0x168 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 29'h160   ) begin
