...
(
    ...
    localparam PAD13 = log2ceil(64'h120 - 64'h118); 
    localparam PAD14 = log2ceil(64'h128 - 64'h120); 
    ...
    // ( 0xe0 .. 0xf0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 29'he0  && read_transaction  ) begin
    ...
    // ( 0x118 .. 0x120 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 29'h118  && read_transaction  ) begin
            src_channel = 17'b00000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 15;
    end

    // ( 0x120 .. 0x128 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 29'h120   ) begin
